...
const Projects = (props: Props) => {
  ...
  return (
   ...
   >
    ...
    <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-30 mt-5  scrollbar-track-gray-400/40 scrollbar-thumb-[#f7ab0a]/70 scrollbar-thin'>
        {
