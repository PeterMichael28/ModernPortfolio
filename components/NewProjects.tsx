 ...
 const projects = [
  {
   ...
   desc:
    "A web accounting software designed for managing inventories, invoicing, receipt bookkeeping and point of sale application. it provides business with comprehensive solutions to manage their business operations seamlessly",
  ...
  },
  {
   ...
   desc:
    "A web application to discover and explore the adventure dubai has to offer. It gives you the best tour experience, and it also  brings you the best, memorable and exquisite experience",
  ...
  },
  {
   ...
   desc:
    "BrandTech Company for all Businesses, Experience a fusion of technology and branding with our all-encompassing brandtech solutions, reshaping audience connections.",
  ...
  },
  {
   ...
   desc:
    "Platform Lead Limited Official Website made with ReactJs, Tailwind Css, EmailJs and etc. A responsive multi-page website that tells more about the company and allows user to find out more about our programs and how we run them. It also allows user to reach out directly to the company through the contact us page with the help of EmailJs that was integrated into it",
...

  {
   ...
   desc:
    "An E-commerce web app created with ReactJs, Bootstrap, Redux-toolKit and Redux for the state Management. A Multi-page e-commerce website that allows you to check through different products and their details. There is also a add to cart functionality that lets you add any item of your choice to your cart",
   live:
    "https://petermichael28.github.io/React-E-commerce/",
   source:
    "https://petermichael28.github.io/React-E-commerce/",
  },
 ];
       ...
       >
        ...
        <div className="space-y-3 px-0 md:px-10 max-w-5xl">
         ...
         <div className="flex justify-center items-center space-x-6">
          <Link
           href={project.live}
           className="bg-[#f7ab0a]/40 px-9 py-2 rounded-md font-semibold tracking-widest hover:border hover:border-[#f7ab0a]/40 transition-all duration-500 hover:bg-[rgba(36,36,36)]"
          >
           Live
          </Link>
          <Link
