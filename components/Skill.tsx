...
const Skill = ({ img, text}: Props) => {
    ...
    <div
     ...
     className='rounded-full '>
        <Image src={img} alt='logo' className='rounded-full border border-gray-500  object-cover h-[70px] w-[70px] xl:w-[85px] xl:h-[85px] filter group-hover:grayscale transition duration-500 ease-in-out' />
    </div>
