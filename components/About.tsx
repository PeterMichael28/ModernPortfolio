  ...
  return (
      <section id='about' className='snap-start h-screen'>
          <div className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-6xl px-3 md:px-10 justify-evenly mx-auto items-center'>
              ...
              >
              <Image src={img1} alt='alt-img' className='-mb-20 md:mb-0 w-44 h-44 rounded-full md:object-cover md:w-64 md:h-96 md:rounded-lg' />
              ...
              <motion.div
                 ...
                 transition={ { duration: 1 } }
                 viewport={ {once: true} }
                  className='space-y-6 px-4 md:px-10 md:w-[60%]'>
